  ...
  return (
    <article className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm transition hover:border-slate-300 hover:shadow-md">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <div className="flex flex-wrap items-center gap-2">
            <h3 className="text-lg font-semibold text-slate-950">{application.company}</h3>
            <span
          ...
          <p className="mt-1 text-base font-medium text-slate-700">{application.position}</p>
        </div>
      ...
      <dl className="mt-5 grid gap-3 text-sm sm:grid-cols-2">
        ...
        <Detail label="Salary" value={application.salaryRange || "Not specified"} />
